...
```php
<?php
require_once('/path/to/EbayFeedApi/vendor/autoload.php');
```
...
To generate:
```
openapi-generator generate -i sell_feed_v1_oas3.json -g php -o ebay_feed_api --additional-properties packageName=EbayFeedApi --additional-properties invokerPackage=Modstore\\EbayFeedApi
```